...
export default defineConfig({
  ...
  head: [
    ["link", { rel: "icon", href: "/profile/White_Ignyte-Logo.png" }],
    [
      "script",
      { id: "hotjar" },
    ...
    ["meta", { name: "og:image", content: "profile/GitHub Ignyte Platform.png" }],
  ],
  ignoreDeadLinks: [
  ...
  themeConfig: {
    ...
    editLink: {
      pattern: "https://github.com/Ignyte-Assurance-Platform/.github/tree/main/profile:path",
    },
    footer: {
      message: "Made with ❤️ by Team Ignyte",
      copyright: "Copyright © 2024 Ignyte Platform All Rights Reserved.",
    },
    search: {
      provider: "local",
    },
